...
levels: {
    ...
    2:  { profBonus: 2, cantripsKnown: 2, spellsKnown: 3,  pactSlots: 2, slotLevel: 1, invocations: 2, features: ['Eldritch Invocations'] },
    3:  { profBonus: 2, cantripsKnown: 2, spellsKnown: 4,  pactSlots: 2, slotLevel: 2, invocations: 2, features: ['Pact Boon'] },
    4:  { profBonus: 2, cantripsKnown: 3, spellsKnown: 5,  pactSlots: 2, slotLevel: 2, invocations: 2, features: ['Ability Score Improvement'] },
    ...
    17: { profBonus: 6, cantripsKnown: 4, spellsKnown: 14, pactSlots: 4, slotLevel: 5, invocations: 8, arcanum6: 1, arcanum7: 1, arcanum8: 1, arcanum9: 1, features: ['Mystic Arcanum (9th level)'] },
