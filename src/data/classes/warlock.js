export const WARLOCK = {
  ...
  levels: {
    ...
    6:  { profBonus: 3, cantripsKnown: 3, spellsKnown: 7,  pactSlots: 2, slotLevel: 3, invocations: 5, features: ['Subclass Feature'] },
    7:  { profBonus: 3, cantripsKnown: 3, spellsKnown: 8,  pactSlots: 2, slotLevel: 4, invocations: 6, features: [] },
    8:  { profBonus: 3, cantripsKnown: 3, spellsKnown: 9,  pactSlots: 2, slotLevel: 4, invocations: 6, features: ['Ability Score Improvement'] },
    9:  { profBonus: 4, cantripsKnown: 3, spellsKnown: 10, pactSlots: 2, slotLevel: 5, invocations: 7, features: [] },
    10: { profBonus: 4, cantripsKnown: 4, spellsKnown: 10, pactSlots: 2, slotLevel: 5, invocations: 7, features: ['Subclass Feature'] },
    11: { profBonus: 4, cantripsKnown: 4, spellsKnown: 11, pactSlots: 3, slotLevel: 5, invocations: 7, arcanum6: 1, features: ['Mystic Arcanum (6th level)'] },
    12: { profBonus: 4, cantripsKnown: 4, spellsKnown: 11, pactSlots: 3, slotLevel: 5, invocations: 8, arcanum6: 1, features: ['Ability Score Improvement'] },
    13: { profBonus: 5, cantripsKnown: 4, spellsKnown: 12, pactSlots: 3, slotLevel: 5, invocations: 8, arcanum6: 1, arcanum7: 1, features: ['Mystic Arcanum (7th level)'] },
    14: { profBonus: 5, cantripsKnown: 4, spellsKnown: 12, pactSlots: 3, slotLevel: 5, invocations: 8, arcanum6: 1, arcanum7: 1, features: ['Subclass Feature'] },
    15: { profBonus: 5, cantripsKnown: 4, spellsKnown: 13, pactSlots: 3, slotLevel: 5, invocations: 9, arcanum6: 1, arcanum7: 1, arcanum8: 1, features: ['Mystic Arcanum (8th level)'] },
    16: { profBonus: 5, cantripsKnown: 4, spellsKnown: 13, pactSlots: 3, slotLevel: 5, invocations: 9, arcanum6: 1, arcanum7: 1, arcanum8: 1, features: ['Ability Score Improvement'] },
    17: { profBonus: 6, cantripsKnown: 4, spellsKnown: 14, pactSlots: 4, slotLevel: 5, invocations: 9, arcanum6: 1, arcanum7: 1, arcanum8: 1, arcanum9: 1, features: ['Mystic Arcanum (9th level)'] },
    18: { profBonus: 6, cantripsKnown: 4, spellsKnown: 14, pactSlots: 4, slotLevel: 5, invocations: 10, arcanum6: 1, arcanum7: 1, arcanum8: 1, arcanum9: 1, features: [] },
    19: { profBonus: 6, cantripsKnown: 4, spellsKnown: 15, pactSlots: 4, slotLevel: 5, invocations: 10, arcanum6: 1, arcanum7: 1, arcanum8: 1, arcanum9: 1, features: ['Ability Score Improvement'] },
    20: { profBonus: 6, cantripsKnown: 4, spellsKnown: 15, pactSlots: 4, slotLevel: 5, invocations: 10, arcanum6: 1, arcanum7: 1, arcanum8: 1, arcanum9: 1, features: ['Eldritch Master'] },
  },
