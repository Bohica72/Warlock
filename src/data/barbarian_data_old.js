...
tableColumns: [
  { key: 'profBonus', label: 'Prof',     flex: 0.7 },
  { key: 'rages',     label: 'Rages',    flex: 0.7 },
  { key: 'rageDmg',   label: 'Rage Dmg', flex: 0.8 },
  { key: 'features',  label: 'Features', flex: 2   },
],


  levels: {
  1:  { profBonus: 2, rages: 2,  rageDmg: '+2', features: ['Rage', 'Unarmored Defense', 'Weapon Mastery'] },
  2:  { profBonus: 2, rages: 2,  rageDmg: '+2', features: ['Danger Sense', 'Reckless Attack'] },
  3:  { profBonus: 2, rages: 3,  rageDmg: '+2', features: ['Barbarian Subclass', 'Primal Knowledge'] },
  4:  { profBonus: 2, rages: 3,  rageDmg: '+2', features: ['Ability Score Improvement'] },
  5:  { profBonus: 3, rages: 3,  rageDmg: '+2', features: ['Extra Attack', 'Fast Movement'] },
  6:  { profBonus: 3, rages: 4,  rageDmg: '+2', features: ['Subclass Feature'] },
  7:  { profBonus: 3, rages: 4,  rageDmg: '+2', features: ['Feral Instinct', 'Instinctive Pounce'] },
  8:  { profBonus: 3, rages: 4,  rageDmg: '+2', features: ['Ability Score Improvement'] },
  9:  { profBonus: 4, rages: 4,  rageDmg: '+3', features: ['Brutal Strike'] },
  10: { profBonus: 4, rages: 4,  rageDmg: '+3', features: ['Subclass Feature'] },
  11: { profBonus: 4, rages: 4,  rageDmg: '+3', features: ['Relentless Rage'] },
  12: { profBonus: 4, rages: 5,  rageDmg: '+3', features: ['Ability Score Improvement'] },
  13: { profBonus: 5, rages: 5,  rageDmg: '+3', features: ['Improved Brutal Strike'] },
  14: { profBonus: 5, rages: 5,  rageDmg: '+3', features: ['Subclass Feature'] },
  15: { profBonus: 5, rages: 5,  rageDmg: '+3', features: ['Persistent Rage'] },
  16: { profBonus: 5, rages: 5,  rageDmg: '+3', features: ['Ability Score Improvement'] },
  17: { profBonus: 6, rages: 6,  rageDmg: '+4', features: ['Improved Brutal Strike'] },
  18: { profBonus: 6, rages: 6,  rageDmg: '+4', features: ['Indomitable Might'] },
  19: { profBonus: 6, rages: 6,  rageDmg: '+4', features: ['Epic Boon'] },
  20: { profBonus: 6, rages: '∞', rageDmg: '+4', features: ['Primal Champion'] },
},
